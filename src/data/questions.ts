...
export const SPECIFIC_QUESTIONS: Record<ProfileType, Question[]> = {
  ...
  suivi_contrat: [
    ...
    { id: 'sc12', text: "Comment tu calcules le montant de la facturation pour une incorporation ? Explique-moi étape par étape comme si je ne connaissais rien.", type: 'specific' },
    { id: 'sc13', text: "Le tarif dépend de quels critères exactement ? (âge du bénéficiaire, lien familial, type de garantie, zone géographique, autre ?)", type: 'specific' },
    { id: 'sc14', text: "Est-ce que tu appliques un prorata temporis ? Si oui, comment tu le calcules ? (à partir de la date d'effet jusqu'à l'échéance du contrat ?)", type: 'specific' },
    { id: 'sc15', text: "Les tarifs viennent d'où ? (une grille tarifaire fixe, un barème par contrat, un document de référence ?) Est-ce que tu peux me montrer cette grille ?", type: 'specific' },
    { id: 'sc16', text: "Est-ce que les tarifs changent selon le type de contrat ou le client ? Ou c'est la même grille pour tout le monde ?", type: 'specific' },
    { id: 'sc17', text: "Y a-t-il des cas particuliers ou des exceptions où le calcul standard ne s'applique pas ? Lesquels ?", type: 'specific' },
    { id: 'sc18', text: "Est-ce que tu appliques des taxes, des frais de gestion ou des majorations en plus du tarif de base ?", type: 'specific' },
    { id: 'sc19', text: "Quand tu fais une erreur de calcul, c'est généralement à quelle étape et pourquoi ?", type: 'specific' },
    { id: 'sc20', text: "Les demandes d'incorporation arrivent toujours dans le même format de document ou ça varie ?", type: 'specific' },
    { id: 'sc21', text: "Quelles informations du bénéficiaire sont obligatoires pour pouvoir lancer le calcul ?", type: 'specific' },
  ],
  direction: [
